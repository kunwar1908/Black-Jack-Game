...
def getCardImages(card_images):
    suits = ['of_hearts', 'of_clubs', 'of_diamonds', 'of_spades']
    ...
    for suit in suits:
        ...
        for card in range(2, 11):
            name = 'C:/Users/kunwa/Python/Projects/black-jack/NumberCards/{}_{}.{}'.format(str(card), suit, ext)
            image = tkinter.PhotoImage(file=name)
            card_images.append((card, image, ))

        # adding the face cards
        for card in faceCards:
            name = 'C:/Users/kunwa/Python/Projects/black-jack/FaceCards/{}_{}.{}'.format(str(card), suit, ext)
            image = tkinter.PhotoImage(file=name)
...
gameWindow.title("Kunwarpreet Singh - Black Jack")
gameWindow.geometry("640x480")

tkinter.Label(gameWindow, text='Kunwarpreet Singh - Black Jack', bg='white',
